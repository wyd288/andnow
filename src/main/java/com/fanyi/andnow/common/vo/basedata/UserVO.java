...
public class UserVO {
    ...
    public Byte getPwdlevel() {
        return pwdlevel;
    }

    public void setPwdlevel(Byte pwdlevel) {
    ...
    public Byte getIdentityverifycode() {
        return identityverifycode;
    }

    public void setIdentityverifycode(Byte identityverifycode) {
